    ...
    return Container(
      ...
      child: Stack(
        ...
        children: [
              ...
              children: [
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    SvgPicture.asset(geTagTypeIcon(car.tagType), width: 25),
                  ],
                ),
                Dimens.space(2),
          ...
          Positioned(
            right: 0,
            child: SvgPicture.asset(AppAssets.eclipse, width: 130, height: 130),
          ),
          Positioned(
            right: 0,
            top: 10,
...
class _LastParkedWidgetState extends State<LastParkedWidget> {
  ...
  void _onMapCreated(HereMapController controller) {
    ...
    _mapController!.mapScene.loadSceneForMapScheme(MapScheme.normalDay, (
      ...
      final parkingLocation = GeoCoordinates(
        widget.lastParked?.lat ?? 37.3318,
