...
import '../../../data/models/product.model.dart' show Product;
import 'redeem_online_success.page.dart';
...
class _RedeemOnlineProcessingViewState extends State<RedeemOnlineProcessingView>
  ...
  Future<void> _simulateProcessing() async {
    ...
    if (mounted) {
      ...
      final voucherCode =
          'LETDEM-${DateTime.now().millisecondsSinceEpoch % 100000}';
