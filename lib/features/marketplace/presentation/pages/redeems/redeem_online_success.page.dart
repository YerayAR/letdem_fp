...
class _RedeemOnlineSuccessViewState extends State<RedeemOnlineSuccessView> {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [AppColors.green600, AppColors.green600.withOpacity(0.7)],
      ...
      child: const Icon(Iconsax.tick_circle5, size: 70, color: Colors.white),
    );
  }
  ...
  Widget _buildVoucherCodeCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [AppColors.purple600, AppColors.purple600.withOpacity(0.8)],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          Row(
            children: [
              Icon(Iconsax.discount_shape, color: AppColors.green600, size: 24),
              Dimens.space(1),
              Text(
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Icon(Iconsax.clock, color: AppColors.neutral600, size: 24),
              Dimens.space(1),
              Text(
                'Tiempo restante',
                style: Typo.mediumBody.copyWith(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Iconsax.info_circle, color: AppColors.primary500, size: 20),
              Dimens.space(1),
              Text(
                'Cómo usar tu código',
                style: Typo.mediumBody.copyWith(
          ...
          Dimens.space(1),
          _buildInstructionItem('2', 'Agrega el producto a tu carrito'),
          Dimens.space(1),
          _buildInstructionItem(
            '3',
