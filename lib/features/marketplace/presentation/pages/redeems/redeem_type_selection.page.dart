...
import '../catalog/redeem_in_store_intro.page.dart';
import 'redeem_online_intro.page.dart';
      ...
      children: [
        _buildRedeemOptionCard(
          ...
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (_) => const RedeemInStoreIntroView()),
            );
          },
        ),
        Dimens.space(2),
        _buildRedeemOptionCard(
          ...
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (_) => const RedeemOnlineIntroView()),
            );
          },
        ),
      ],
    ...
    showDialog(
      ...
      builder:
          (context) => AlertDialog(
            ...
            title: Row(
              children: [
                Icon(Iconsax.info_circle, color: AppColors.primary500),
                Dimens.space(1),
                Text(
                  'Próximamente',
