...
import 'purchase_with_redeem.page.dart';
import 'purchase_without_redeem.page.dart';
...
class PurchaseRedeemQuestionView extends StatelessWidget {
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Icon(Iconsax.ticket_discount, color: Colors.white, size: 48),
          ),
              ...
              children: [
                Text(
                  ...
                  style: Typo.mediumBody.copyWith(
                    fontWeight: FontWeight.w700,
                    color:
                        hasEnoughPoints ? AppColors.green700 : AppColors.red700,
                  ),
                ),
                ...
                Text(
                  ...
                  style: Typo.smallBody.copyWith(
                    color:
                        hasEnoughPoints ? AppColors.green600 : AppColors.red600,
                  ),
                ),
              ],
            ),
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Icon(Iconsax.wallet_add, size: 16, color: AppColors.green600),
  ...
  Widget _buildPriceOption(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(8),
        border: Border.all(color: color, width: isRecommended ? 2 : 1),
      ),
      child: Column(
        children: [
          Text(
  ...
  Widget _buildInsufficientPointsCard(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          Icon(Iconsax.info_circle, color: AppColors.red500, size: 48),
          const SizedBox(height: 12),
          Text(
