...
class _CartCheckoutViewState extends State<CartCheckoutView> {
        ...
        builder: (context, cartState) {
          return BlocBuilder<UserBloc, UserState>(
            builder: (context, userState) {
              ...
              final walletBalance = earningAccount?.availableBalance ?? earningAccount?.balance ?? 0.0;
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildPointsSection(cartState, availablePoints, insufficientPoints),
                          const SizedBox(height: 16),
                          _buildPaymentSection(walletBalance, cartState.total, insufficientBalance),
                        ],
                      ),
                    ),
                  ),
                  _buildBottomBar(context, cartState, insufficientPoints, insufficientBalance),
                ],
              );
            },
          );
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSummaryRow('Subtotal', '\$${cartState.subtotal.toStringAsFixed(2)}', bold: false),
          ...
          _buildSummaryRow('Total', '\$${cartState.total.toStringAsFixed(2)}', bold: true),
        ],
      ),
    );
  }
  ...
  Widget _buildPointsSection(CartState cartState, int availablePoints, bool insufficientPoints) {
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(
                insufficientPoints ? Iconsax.warning_2 : Iconsax.ticket_discount,
              ...
              Expanded(
                child: Text(
                  ...
                  style: Typo.mediumBody.copyWith(
                    fontWeight: FontWeight.w700,
                    color: insufficientPoints ? AppColors.red700 : AppColors.green700,
                  ),
                ),
              ),
            ],
  ...
  Widget _buildPaymentSection(double balance, double total, bool insufficientBalance) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: Colors.white,
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            padding: const EdgeInsets.all(12),
            decoration: BoxDecoration(
              color: insufficientBalance ? AppColors.red50 : AppColors.primary50,
              borderRadius: BorderRadius.circular(8),
              border: Border.all(
                color: insufficientBalance ? AppColors.red200 : AppColors.primary200,
              ),
            ),
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: Typo.mediumBody.copyWith(
                        fontWeight: FontWeight.w700,
                        color: insufficientBalance ? AppColors.red600 : AppColors.green600,
                      ),
                    ),
                  ],
                ),
  ...
  Widget _buildBottomBar(BuildContext context, CartState cartState, bool insufficientPoints, bool insufficientBalance) {
    final canProceed = !insufficientPoints && !insufficientBalance && !_isProcessing;
      ...
      child: SafeArea(
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
            onPressed: canProceed ? () => _handleCheckout(context, cartState) : null,
            style: ElevatedButton.styleFrom(
  ...
  Future<void> _handleCheckout(BuildContext context, CartState cartState) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Error al procesar el pago: $e', style: Typo.mediumBody.copyWith(color: Colors.white)),
        ...
        content: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(Iconsax.tick_circle5, color: AppColors.green600, size: 48),
            ),
            const SizedBox(height: 16),
            Text('¡Compra exitosa!', style: Typo.largeBody.copyWith(fontWeight: FontWeight.w700), textAlign: TextAlign.center),
            const SizedBox(height: 8),
            Text(
            ...
            Text(
              ...
              style: Typo.mediumBody.copyWith(fontWeight: FontWeight.w700, color: AppColors.primary500),
              textAlign: TextAlign.center,
            ),
          ],
        ),
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                Navigator.of(context).pushAndRemoveUntil(
                  MaterialPageRoute(builder: (_) => const MarketplaceStartView()),
                  (route) => false,
                );
              },
              style: ElevatedButton.styleFrom(
              ...
              child: Text('Volver al inicio', style: Typo.mediumBody.copyWith(color: Colors.white, fontWeight: FontWeight.w700)),
            ),
          ),
        ],
      ),
