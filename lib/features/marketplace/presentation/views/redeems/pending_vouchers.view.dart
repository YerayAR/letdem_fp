...
class PendingVouchersView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => PendingVouchersCubit(MarketplaceRepository())..loadPendingVouchers(),
...
class _PendingVouchersContent extends StatefulWidget {
  ...
  @override
  State<_PendingVouchersContent> createState() => _PendingVouchersContentState();
}
...
class _PendingVouchersContentState extends State<_PendingVouchersContent> {
    ...
    return Scaffold(
      ...
      body: BlocConsumer<PendingVouchersCubit, PendingVouchersState>(
        ...
        builder: (context, state) {
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    onPressed: () => context.read<PendingVouchersCubit>().refreshVouchers(),
          ...
          if (state is PendingVouchersLoaded || state is PendingVouchersCancelling) {
            final vouchers = state is PendingVouchersLoaded 
                ? state.vouchers 
            ...
            return RefreshIndicator(
              onRefresh: () => context.read<PendingVouchersCubit>().refreshVouchers(),
              child: Column(
                children: [
                  _buildFilterBar(),
                  Expanded(
                    child: filteredVouchers.isEmpty
                        ...
                        : ListView(
                            ...
                            children: [
                              _buildInfoCard(),
                              Dimens.space(2),
                              ...filteredVouchers.map((voucher) => _buildVoucherCard(
                                context,
                                voucher,
  ...
  Widget _buildVoucherCard(BuildContext context, Voucher voucher, bool isCancelling) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isExpiringSoon ? AppColors.secondary600.withOpacity(0.3) : AppColors.neutral200,
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                Icon(
                  voucher.redeemType == 'ONLINE' ? Iconsax.global : Iconsax.shop,
                  size: 18,
                  color: voucher.redeemType == 'ONLINE' 
                      ? AppColors.purple600 
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  padding: const EdgeInsets.all(12),
                  decoration: BoxDecoration(
                    color: isExpiringSoon ? AppColors.secondary50 : AppColors.primary50,
                    borderRadius: BorderRadius.circular(8),
                    border: Border.all(
                  ...
                  child: Row(
                    children: [
                      Icon(
                        ...
                        size: 18,
                        color: isExpiringSoon ? AppColors.secondary600 : AppColors.primary600,
                      ),
                      const SizedBox(width: 8),
                      Expanded(
                        child: Column(
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton.icon(
                      ...
                      icon: Icon(
                        ...
                        size: 18,
                        color: isCancelling ? AppColors.neutral400 : AppColors.red600,
                      ),
                      label: Text(
                      ...
                      style: OutlinedButton.styleFrom(
                        side: BorderSide(
                          color: isCancelling ? AppColors.neutral300 : AppColors.red600,
                        ),
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              context.read<PendingVouchersCubit>().cancelVoucher(voucher.id);
            },
            style: ElevatedButton.styleFrom(
              backgroundColor: AppColors.red600,
              foregroundColor: Colors.white,
