...
import 'package:letdem/features/marketplace/models/order.model.dart';
...
class OrderHistoryView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => OrderHistoryCubit(MarketplaceRepository())..loadOrderHistory(),
        ...
        builder: (context, state) {
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    onPressed: () => context.read<OrderHistoryCubit>().refreshOrderHistory(),
          ...
          if (state is OrderHistoryLoaded) {
            if (state.orders.isEmpty) {
              return Center(
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Iconsax.shopping_bag, size: 64, color: AppColors.neutral300),
                    const SizedBox(height: 16),
                    Text(
            ...
            return RefreshIndicator(
              onRefresh: () => context.read<OrderHistoryCubit>().refreshOrderHistory(),
              child: ListView(
  ...
  Widget _buildStatItem(String label, String value, IconData icon) {
    return Column(
      ...
      children: [
        ...
        Text(
          label,
          style: Typo.smallBody.copyWith(color: Colors.white70),
        ),
      ],
    );
  }
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Icon(Iconsax.calendar, size: 14, color: AppColors.neutral600),
                ...
                if (order.usedPoints) ...[
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Icon(Iconsax.ticket_discount, size: 14, color: AppColors.green600),
                        const SizedBox(width: 4),
                        Text(
