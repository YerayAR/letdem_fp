...
// Host base para WebSockets. Debe ir en formato
...
class LocationWebSocketService {
  ...
  void connectAndSendInitialLocation({
    ...
    final wsUrl = Uri.parse('$_wsBaseUrl/maps/nearby?token=$token');
...
class UserWebSocketService {
  ...
  Future<void> connect({
    ...
    final wsUrl = Uri.parse('$_wsBaseUrl/users/refresh?token=$token');
